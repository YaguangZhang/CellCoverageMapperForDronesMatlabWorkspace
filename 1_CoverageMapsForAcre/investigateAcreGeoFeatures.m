...
[highResGridUtmLatMat, highResGridUtmLonMat] ...
...
for idxNoG = 1:length(numsOfGroups)
    ...
    figure('Position', [0, 0, figureSize], ...
        'PaperPositionMode', 'auto'); colormap turbo;
    plot3k([gridLatLonPts(:, [2,1]), eleGraMagsToShow], ...
        'ColorBar', false);
...
figure('Position', [0, 0, figureSize], ...
    'PaperPositionMode', 'auto'); colormap turbo;
plot3k([highResGridUtmLonMat(boolsHighResGridPtsInAcre), ...
    highResGridUtmLatMat(boolsHighResGridPtsInAcre), eleMatsToPlot], ...
