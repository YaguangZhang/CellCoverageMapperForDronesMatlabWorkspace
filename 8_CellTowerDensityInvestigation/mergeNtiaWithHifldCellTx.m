...
hPolyIn = plot(boundOfInterestLons, boundOfInterestLats, ...
    '-', 'LineWidth', 5, 'Color', 'g'); % ones(1,3).*0.3
...
legend([hHifldCellTowers, hNtiaNewRecords, hNtiaIgnoredRecords, ...
    hPolyIn], ...
    'HIFLD Cell Towers', 'New Towers from NTIA', 'Ignored NTIA Records', ...
    'Indiana', ...
