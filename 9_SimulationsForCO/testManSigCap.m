...
if flagGenKmlOverview
    ...
    % lines are not completely blocking each other visually. TODO: somehow
    % the colors follow the traditional AARRGGBB format instead of the KML
    % AABBGGRR format.
    lineWidth = 6;
    lineColorAtt = 'FFFF0000';
    lineColorVer = 'FF0000FF';
    lineColorTM = 'FF00FF00';
    ...
    for idxPreset = 1:numOfPresets
        ...
        switch lower(MARKER_STYLE)
            ...
            case lower('Line')
                if any(boolsIsAtt)
                    kmlPtGroupsCell{end+1} = ge_plot( ...
                        allLons(boolsIsAtt), ...
                        allLats(boolsIsAtt), 'name', 'ATT', ...
                ...
                if any(boolsIsVer)
                    kmlPtGroupsCell{end+1} = ge_plot( ...
                        allLons(boolsIsVer), ...
                        allLats(boolsIsVer), 'name', 'Verizon', ...
                ...
                if any(boolsIsTM)
                    kmlPtGroupsCell{end+1} = ge_plot( ...
                        allLons(boolsIsTM), ...
                        allLats(boolsIsTM), 'name', 'T-Mobile', ...
