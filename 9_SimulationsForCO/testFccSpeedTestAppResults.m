...
pathToFccSpeedTestAppResults = fullfile(ABS_PATH_TO_SHARED_FOLDER, ...
    'FCC Rural Broadband', 'FCC_SpeedTest_Anderson_20211014');
...
plot3k([downEndLatLons(:, [2, 1]), downSpeedsBps./(10^6)], ...
    'Labels', {'Download Speed (End) on Map', '', '', '', ...
    'Data Rate (Mbps)'}, ...
...
plot3k([downEndLatLons(:, [2, 1]), upSpeedsBps./(10^6)], ...
    'Labels', {'Upload Speed (End) on Map', '', '', '', ...
    'Data Rate (Mbps)'}, ...
    'Plottype','stem', 'Marker', {'.', 12});
xticklabels([]); yticklabels([]); view(3);
plot_google_map('MapType', 'Hybrid');
...
title('Download Speed (End) by Operating System'); 
...
title('Upload Speed (End) by Operating System'); 
zlabel('Data Rate (Mbps)');
xticklabels([]); yticklabels([]); view(3);
legend([hMAnd, hMIos], 'Android', 'iOS', 'Location','best');
plot_google_map('MapType', 'Hybrid');
...
assert(all(boolsIsAtt|boolsIsVer|boolsIsTM), 'Unknown carrier(s)!');
...
title('Download Speed (End) by Carriers'); 
zlabel('Data Rate (Mbps)');
xticklabels([]); yticklabels([]); view(3);
...
title('Upload Speed (End) by Carriers'); 
zlabel('Data Rate (Mbps)');
xticklabels([]); yticklabels([]); view(3);
legend([hMAtt, hMVer, hMTM], 'AT&T', 'Verizon', 'T-Mobile', ...
    'Location','best');
