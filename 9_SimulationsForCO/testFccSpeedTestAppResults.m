...
for idxLog = 1:numOfLogs
    ...
    try
        ...
        indicesAndroidLogs = [indicesAndroidLogs; idxLog]; %#ok<SAGROW>
        ...
        indicesIosLogs = [indicesIosLogs; idxLog]; %#ok<SAGROW>
...
rawTestResults = cell2table([osVersions, carriers, ...
    ...
    num2cell(upEndLatLons, 2), num2cell(upSpeedsBps)]);
rawTestResults.Properties.VariableNames = {'osVersion','carrier', ...
    'downEndLatLons','downSpeedsBps','upEndLatLons','upSpeedsBps'};
