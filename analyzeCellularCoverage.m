...
if ~exist('PRESET', 'var')
    ...
    %   'ACRE_LORAWAN_2021', 'ACRE_LORAWAN_ANDREW'}.
    ...
    % For the Lafayette Downtown scenario specified by boundaries and
    % towers from Ahmed.
    %   {'LafayetteDowntown_ML', 'LafayetteValleySt_ML',
    %   'LafayetteIndustrial_ML'}
    % For calibration scenarios specified by boundaries and towers from
    % Ahmed.
    %   {'calibrationML-1', ..., 'calibrationML-7'}
    % For repeated simulation scenarios with new tower locations from
    % Ahmed.
    %   {'ACRE_ML_20241123', 'LafayetteDowntown_ML_20241123',
    %    'HappyHollowPark_ML_20241123', 'LindbergVillage_ML_20241123',
    %   'LafayetteIndustrial_ML_20241123', 'LafayetteValleySt_ML_20241123'}
    PRESET = 'invalid';
end
...
switch PRESET
    ...
    case {'ACRE_ML_20241123'}
        ABS_PATH_TO_CELL_ANTENNAS_CSV = fullfile( ...
            ABS_PATH_TO_SHARED_FOLDER, ...
            'CellTowerInfo', ...
            'ACRECellTowers_AntennaSearch_20241123.csv');
    case {'HappyHollowPark_ML'}
        ABS_PATH_TO_CELL_ANTENNAS_CSV = fullfile( ...
            ABS_PATH_TO_SHARED_FOLDER, ...
            'CellTowerInfo', ...
            'HappyHollowParkCellTowers_AntennaSearch_20230911.csv');
    case {'HappyHollowPark_ML_20241123'}
        ABS_PATH_TO_CELL_ANTENNAS_CSV = fullfile( ...
            ABS_PATH_TO_SHARED_FOLDER, ...
            'CellTowerInfo', ...
            'HappyHollowCellTowers_AntennaSearch_20241123.csv');
    case {'LindbergVillage_ML'}
        ABS_PATH_TO_CELL_ANTENNAS_CSV = fullfile( ...
            ABS_PATH_TO_SHARED_FOLDER, ...
            'CellTowerInfo', ...
            'LindbergVillageCellTowers_AntennaSearch_20230911.csv');
    case {'LindbergVillage_ML_20241123'}
        ABS_PATH_TO_CELL_ANTENNAS_CSV = fullfile( ...
            ABS_PATH_TO_SHARED_FOLDER, ...
            'CellTowerInfo', ...
            'LindbergCellTowers_AntennaSearch_20241123.csv');
    case {'LafayetteDowntown_ML'}
        ABS_PATH_TO_CELL_ANTENNAS_CSV = fullfile( ...
            ABS_PATH_TO_SHARED_FOLDER, ...
            'CellTowerInfo', ...
            'DowntownCellTowers_AntennaSearch_20240715.csv');
    case {'LafayetteDowntown_ML_20241123'}
        ABS_PATH_TO_CELL_ANTENNAS_CSV = fullfile( ...
            ABS_PATH_TO_SHARED_FOLDER, ...
            'CellTowerInfo', ...
            'DowntownCellTowers_AntennaSearch_20241123.csv');
    case {'LafayetteValleySt_ML'}
        ABS_PATH_TO_CELL_ANTENNAS_CSV = fullfile( ...
            ABS_PATH_TO_SHARED_FOLDER, ...
            'CellTowerInfo', ...
            'ValleyStCellTowers_AntennaSearch_20240716.csv');
    case {'LafayetteValleySt_ML_20241123'}
        ABS_PATH_TO_CELL_ANTENNAS_CSV = fullfile( ...
            ABS_PATH_TO_SHARED_FOLDER, ...
            'CellTowerInfo', ...
            'ValleyCellTowers_AntennaSearch_20241123.csv');
    case {'LafayetteIndustrial_ML'}
        ABS_PATH_TO_CELL_ANTENNAS_CSV = fullfile( ...
            ABS_PATH_TO_SHARED_FOLDER, ...
            'CellTowerInfo', ...
            'IndustrialCellTowers_AntennaSearch_20240718.csv');
    case {'LafayetteIndustrial_ML_20241123'}
        ABS_PATH_TO_CELL_ANTENNAS_CSV = fullfile( ...
            ABS_PATH_TO_SHARED_FOLDER, ...
            'CellTowerInfo', ...
            'IndustrialCellTowers_AntennaSearch_20241123.csv');
    case {'calibrationML-1', 'calibrationML-2', ...
            'calibrationML-3', 'calibrationML-4', ...
            'calibrationML-5', 'calibrationML-6', ...
            'calibrationML-7'}
        antCsvFullFileName = ['Group', PRESET(length(PRESET)), ...
            'CellTower_AntennaSearch.csv'];
        ABS_PATH_TO_CELL_ANTENNAS_CSV = fullfile( ...
            ABS_PATH_TO_SHARED_FOLDER, ...
            'CellTowerInfo', ...
            antCsvFullFileName);
...
switch PRESET
    ...
    case 'ACRE_LORAWAN_ANDREW'
        % Based on the area of interest provided by Andrew on 20231109.
        simConfigs.UTM_X_Y_BOUNDARY_OF_INTEREST ...
            = constructUtmRectanglePolyMat(...
            [40.4615318, -87.1268342; ...
            40.5434988, -86.9651375]);
    case {'ACRE_LORA_TRAILER', 'ACRE_LORA_TRAILER_INDIVIDUAL_GATEWAY'}
    ...
    case {'LafayetteIndustrial_ML_20241123'}
        ...
        simConfigs.UTM_X_Y_BOUNDARY_OF_INTEREST ...
            ...
            [40.409700, -86.861300; ...
            40.432800, -86.845500]);
    case 'calibrationML-1'
        % Use a square area with boundary coordinates.
        simConfigs.UTM_X_Y_BOUNDARY_OF_INTEREST ...
            = constructUtmRectanglePolyMat(...
            [40.372194, -86.928399; 40.398176, -86.905192]);
    case 'calibrationML-2'
        % Use a square area with boundary coordinates.
        simConfigs.UTM_X_Y_BOUNDARY_OF_INTEREST ...
            = constructUtmRectanglePolyMat(...
            [40.383888, -86.883548; 40.403023, -86.847920]);
    case 'calibrationML-3'
        % Use a square area with boundary coordinates.
        simConfigs.UTM_X_Y_BOUNDARY_OF_INTEREST ...
            = constructUtmRectanglePolyMat(...
            [40.402835, -86.863597; 40.422534, -86.809852]);
    case 'calibrationML-4'
        % Use a square area with boundary coordinates.
        simConfigs.UTM_X_Y_BOUNDARY_OF_INTEREST ...
            = constructUtmRectanglePolyMat(...
            [40.424730, -86.882935; 40.446200, -86.848844]);
    case 'calibrationML-5'
        % Use a square area with boundary coordinates.
        simConfigs.UTM_X_Y_BOUNDARY_OF_INTEREST ...
            = constructUtmRectanglePolyMat(...
            [40.413743, -86.908595; 40.428558, -86.882098]);
    case 'calibrationML-6'
        % Use a square area with boundary coordinates.
        simConfigs.UTM_X_Y_BOUNDARY_OF_INTEREST ...
            = constructUtmRectanglePolyMat(...
            [40.412857, -86.932646; 40.440362, -86.899744]);
    case 'calibrationML-7'
        % Use a square area with boundary coordinates.
        simConfigs.UTM_X_Y_BOUNDARY_OF_INTEREST ...
            = constructUtmRectanglePolyMat(...
            [40.444143, -86.941359; 40.467816, -86.900864]);
...
if exist('NUM_OF_PIXELS_FOR_LONGER_SIDE', 'var')
    ...
    simConfigs.NUM_OF_PIXELS_FOR_LONGER_SIDE = 100; % 360;
end
...
switch PRESET
    ...
    case {'UniOfCoBoulderCampus', ...
            ...
            'LafayetteIndustrial_ML', ...
            'ACRE_ML_20241123', 'LafayetteDowntown_ML_20241123', ...
            'HappyHollowPark_ML_20241123', ...
            'LindbergVillage_ML_20241123', ...
            'LafayetteIndustrial_ML_20241123', ...
            'LafayetteValleySt_ML_20241123', ...
            'calibrationML-1', 'calibrationML-2', ...
            'calibrationML-3', 'calibrationML-4', ...
            'calibrationML-5', 'calibrationML-6', ...
            'calibrationML-7'}
        simConfigs.RX_ANT_HEIGHTS_TO_INSPECT_IN_M = 1.5;
...
simConfigs.LOS_FIRST_FRES_CLEAR_RATIO = 0.6; % 0.1;
...
if startsWith(PRESET, {'ACRE_LORA_', 'ACRE_LORAWAN_ANDREW', ...
        'UniOfCoBoulderCampus'})
    disp(' ')
    disp(['    [', datestr(now, datetimeFormat), ...
