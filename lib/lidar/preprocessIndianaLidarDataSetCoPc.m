function [lidarFileRelDirs, xYBoundryPolygons, lonLatBoundryPolygons] ...
    = preprocessIndianaLidarDataSetCoPc(ABS_PATH_TO_LOAD_LIDAR, ...
    DEG2UTM_FCT, UTM2DEG_FCT)
%PREPROCESSINDIANALIDARDATASETCOPC Preprocess the LiDAR data set (Colorado,
%Point Cloud, LAS stored as .zip) located at ABS_PATH_TO_LOAD_LIDAR.
%
