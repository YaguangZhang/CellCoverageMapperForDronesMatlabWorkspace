...
for idxEffeCellAnt = nextIdxEffeCellAnt:numOfEffeCellAnts
    ...
    % if simConfigs.FLAG_EVAL_LOSS_THROUGH_VEG is true, or
    %   [blockagePl, coveragePl, pixelExecTime, idxDroneLoc,
    %   idxDroneHeightInM, blockageDistInM]
    % if simConfigs.FLAG_EVAL_LOSS_THROUGH_VEG is false.
...
if simConfigs.FLAG_EVAL_LOSS_THROUGH_VEG
    ...
    [simState.blockageMaps, simState.coverageMaps, ...
        simState.blockageDistMaps] = deal(cell(1, numOfRxHeightToInspect));
end
