...
for curIdxTile = unique(indicesClosestTile)'
    ...
    boolsProfileSampsInCurTile( ...
        boolsProfileSampsWithCurTileAsClosest) = inpoly2( ...
        profileSampLocs(boolsProfileSampsWithCurTileAsClosest,:), ...
        xYBoundryPolygon.Vertices);
    ...
    if any(boolsProfileSampsNearCurTile)
        try
            boolsProfileSampsNearCurTile( ...
                boolsCandidateProfileSampsNearCurTile) = inpoly2( ...
                profileSampLocs( ...
                boolsCandidateProfileSampsNearCurTile,:), ...
                xYBoundryPolygonExt.Vertices);
        catch err
