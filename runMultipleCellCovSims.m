...
%   - {'sixSetsForNewTowerLocs20241123'}
%     Simulate 6 sets of measurement scenarios to help Ahmed to get updated
%     simulation results with new towers.

SIM_GROUP_PRESET = 'sixSetsForNewTowerLocs20241123';
...
switch SIM_GROUP_PRESET
    ...
    case 'diffFreqLafayetteDowntown'
        ...
        % simulate.
        NUMS_OF_PIXELS_FOR_LONGER_SIDE = 100; % 256;
    case 'diffFreqLafayetteValleySt'
        % Presets of interest.
        PRESETS = {'LafayetteValleySt_ML'};
        % Carrier frequencies from Ahmed.
        CARRIER_FREQUENCIES_IN_MHZ = ...
            {731.5, 742.5, 751, 885, ...
            1955, 1970.1, 1970.3, 1977.5, ...
            2115, 2125, 2132.5, 2140, 2150, 2160, 2167.5, 2175, ...
            2355, 2506, 2525.8, ...
            3560, 3580.2, 3730.08, 3809.28};

        % Number of pixels for the longer side of the area of interest to
        % simulate.
        NUMS_OF_PIXELS_FOR_LONGER_SIDE = 100; % 256;
    case 'diffFreqLafayetteIndustrial'
        % Presets of interest.
        PRESETS = {'LafayetteIndustrial_ML'};
        % Carrier frequencies from Ahmed.
        CARRIER_FREQUENCIES_IN_MHZ = ...
            {731.5, 742.5, 751, 885, 885.1, ...
            1955, 1970.1, 1977.5, ...
    ...
    case 'sevenSetsForcalibrationML'
        ...
        % simulate.
        NUMS_OF_PIXELS_FOR_LONGER_SIDE = 100; % 256;
    case 'sixSetsForNewTowerLocs20241123'
        % Presets of interest.
        PRESETS = {'ACRE_ML_20241123', ...
            'LafayetteDowntown_ML_20241123', ...
        ...
        CARRIER_FREQUENCIES_IN_MHZ = num2cell(unique(...
            ...
            731.5, 742.5, 885, ...
            1955, 1970.1, 1977.5, ...
            2125, 2150, 2175, 2355, 2506, 2525.8, 3560, 3730.08, ...
            ... HappyHollow
            731.5, 742.5, 763, 885, ...
            1955, 1970.1, 1985, ...
            2115, 2125, 2132.5, 2140, 2150, 2160, 2167.5, ...
            2355, 2506, 2525.8, ...
            ... Lindberg
            731.5, 742.5, 751, 763, 885, ...
            1955, 1970.1, 1970.3, 1977.5, 1985, ...
            2115, 2125, 2132.5, 2140, 2150, 2160, 2167.5, 2175, ...
            2355, 2506, 2525.8, ...
            3640.4, 3660.2, 3680, 3730.08, ...
            ... Industrial
            731.5, 742.5, 751, 885, 885.1, ...
            1955, 1970.1, 1977.5, ...
            2125, 2132.5, 2140, 2150, 2160, 2167.5, 2175, ...
